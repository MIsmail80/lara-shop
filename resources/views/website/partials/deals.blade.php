            ...
            <div class="slideshow5_slider row clearfix" data-slick='{"dots": false}'>
                <div class="item col">
                    <div class="supermarket_deals_item text-center clearfix">
                        ...
                        <a href="#!" class="item_image">
                            <img src="{{asset('assets/images/shop/supermarket/img_01.png')}}" alt="image_not_found">
                        </a>
                ...
                <div class="item col">
                    <div class="supermarket_deals_item text-center clearfix">
                        <div class="offer_text">Flat -30%</div>
                        <a href="#!" class="item_image">
                            <img src="{{asset('assets/images/shop/supermarket/img_02.png')}}" alt="image_not_found">
                        </a>
                        <div class="item_content">
                            <h3 class="item_title">
                                <a href="#!"> Baby Shoes </a>
                ...
                <div class="item col">
                    <div class="supermarket_deals_item text-center clearfix">
                        <div class="offer_text">Flat -30%</div>
                        <a href="#!" class="item_image">
                            <img src="{{asset('assets/images/shop/supermarket/img_03.png')}}" alt="image_not_found">
                        </a>
                        <div class="item_content">
                            <h3 class="item_title">
                                <a href="#!"> Baby Shoes </a>
                ...
                <div class="item col">
                    <div class="supermarket_deals_item text-center clearfix">
                        <div class="offer_text">Flat -30%</div>
                        <a href="#!" class="item_image">
                            <img src="{{asset('assets/images/shop/supermarket/img_04.png')}}" alt="image_not_found">
                        </a>
                        <div class="item_content">
                            <h3 class="item_title">
                                <a href="#!"> Baby Shoes </a>
