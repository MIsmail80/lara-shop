                ...
                <ul class="supermarket_product_columns has_3columns ul_li bg_white clearfix">
                    <li>
                        <div class="supermarket_product_listlayout">
                            <div class="slideshow1_slider item_image" data-slick='{"arrows": false}'>
                                <div class="item">
                                    <img src="{{asset('assets/images/shop/supermarket/img_16.png')}}" alt="image_not_found">
                                </div>
                                <div class="item">
                                    <img src="{{asset('assets/images/shop/supermarket/img_16.png')}}" alt="image_not_found">
                                </div>
                    ...
                    <li>
                        <div class="supermarket_product_listlayout">
                            <div class="item_image">
                                <div class="item">
                                    <img src="{{asset('assets/images/shop/supermarket/img_18.png')}}" alt="image_not_found">
                                </div>
                    ...
                    <li>
                        <div class="supermarket_product_listlayout">
                            <div class="slideshow1_slider item_image" data-slick='{"arrows": false}'>
                                <div class="item">
                                    <img src="{{asset('assets/images/shop/supermarket/img_17.png')}}" alt="image_not_found">
                                </div>
                                <div class="item">
