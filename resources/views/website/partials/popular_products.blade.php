                ...
                <div class="ecommerce_product_grid">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="ptab1_2" class="tab-pane fade">
                            <div class="item_image">
                                <img src="{{ asset('assets/images/shop/classic_ecommerce/img_02.png') }}"
                                    alt="image_not_found">
                            </div>
                        </div>
                        <div id="ptab1_3" class="tab-pane fade">
                            <div class="item_image">
                                <img src="{{ asset('assets/images/shop/classic_ecommerce/img_03.png') }}"
                                    alt="image_not_found">
                            </div>
                        </div>
                        <ul class="product_action_btns ul_li_center clearfix">
                            ...
                            <li>
                                <a class="tooltips" data-placement="top" title="Quick View" href="{{route('website.products' , $product->id)}}"
                                    data-toggle="modal" data-target="#quickview_modal">
                    ...
                    <div class="item_content">
                        <h3 class="item_title">
                            <a href="{{route('website.products' , $product->id)}}">{{$product->name}}</a>
                        </h3>
                        <ul class="product_color ul_li nav clearfix">
                            <li class="active"><a class="pbg_brown" data-toggle="tab" href="#ptab1_1"></a>
                            </li>
                            <li><a class="pbg_olivegreen" data-toggle="tab" href="#ptab1_2"></a></li>
                            <li><a class="pbg_gray" data-toggle="tab" href="#ptab1_3"></a></li>
                        </ul>
                        <span class="item_price"><strong>{{$product->price}}</strong>
                            {{-- <del>$30.00</del> --}}
                            </span>
                    </div>
                </div>
