						...
						<ul class="ul_li clearfix">
							<li>
								<div class="supermarket_policy_item clearfix">
									<div class="item_icon">
										<img src="{{asset('assets/images/icons/supermarket/icon_12.png')}}" alt="icon_not_found">
									</div>
							...
							<li>
								<div class="supermarket_policy_item clearfix">
									<div class="item_icon">
										<img src="{{asset('assets/images/icons/supermarket/icon_13.png')}}" alt="icon_not_found">
									</div>
									<div class="item_content">
							...
							<li>
								<div class="supermarket_policy_item clearfix">
									<div class="item_icon">
										<img src="{{asset('assets/images/icons/supermarket/icon_14.png')}}" alt="icon_not_found">
									</div>
									<div class="item_content">
							...
							<li>
								<div class="supermarket_policy_item clearfix">
									<div class="item_icon">
										<img src="{{asset('assets/images/icons/supermarket/icon_15.png')}}" alt="icon_not_found">
									</div>
									<div class="item_content">
