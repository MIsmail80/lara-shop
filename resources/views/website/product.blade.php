                                ...
                                <div class="shop_details_image">
                                    <div class="tab-content zoom-gallery">
                                        <div id="tab_1" class="tab-pane active">
                                            <a class="popup_image zoom-image" data-image="{{asset('assets/images/details/shop/img_01.jpg')}}" href="{{asset('assets/images/details/shop/img_01.jpg')}}">
                                            <img src="{{asset('assets/images/details/shop/img_01.jpg')}}" alt="image_not_found">
                                            </a>
                                        </div>
                                        ...
                                        <div id="tab_3" class="tab-pane fade">
                                            <a class="popup_image" href="{{asset('assets/images/details/shop/img_06.jpg')}}">
                                            <img src="{{asset('assets/images/details/shop/img_06.jpg')}}" alt="image_not_found">
                                            </a>
                                        </div>
                                    ...
                                    <ul class="nav ul_li clearfix" role="tablist">
                                        <li>
                                            <a class="active" data-toggle="tab" href="#tab_1">
                                                <img src="{{asset('assets/images/details/shop/img_02.jpg')}}" alt="image_not_found">
                                            </a>
                                        </li>
                                        <li>
                                            <a data-toggle="tab" href="#tab_2">
                                                <img src="{{asset('assets/images/details/shop/img_03.jpg')}}" alt="image_not_found">
                                            </a>
                                        </li>
                                        <li>
                                            <a data-toggle="tab" href="#tab_3">
                                                <img src="{{asset('assets/images/details/shop/img_04.jpg')}}" alt="image_not_found">
                                            </a>
                                        </li>
                                        <li>
                                            <a data-toggle="tab" href="#tab_4">
                                                <img src="{{asset('assets/images/details/shop/img_05.jpg')}}" alt="image_not_found">
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                            ...
                                            <div class="tab-content">
                                                <div id="ptab1_1" class="tab-pane fade active">
                                                    <div class="item_image">
                                                        <img src="{{asset('assets/images/shop/classic_ecommerce/img_01.png')}}" alt="image_not_found">
                                                    </div>
                                                </div>
                                                <div id="ptab1_2" class="tab-pane fade">
                                                    <div class="item_image">
                                                        <img src="{{asset('assets/images/shop/classic_ecommerce/img_02.png')}}" alt="image_not_found">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="ecommerce_product_grid">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div id="ptab2_3" class="tab-pane fade">
                                                    <div class="item_image">
                                                        <img src="{{asset('assets/images/shop/classic_ecommerce/img_04.png')}}" alt="image_not_found">
                                                    </div>
                                                </div>
                                                <ul class="product_action_btns ul_li_center clearfix">
                                                    <li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
                                        ...
                                        <div class="ecommerce_product_grid">
                                            <div class="tab-content">
                                                ...
                                                <div id="ptab3_3" class="tab-pane fade">
                                                    <div class="item_image">
                                                        <img src="{{asset('assets/images/shop/classic_ecommerce/img_05.png')}}" alt="image_not_found">
                                                    </div>
                                                </div>
                                                <ul class="product_action_btns ul_li_center clearfix">
                                                    <li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
                                        ...
                                        <div class="ecommerce_product_grid">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div id="ptab4_3" class="tab-pane fade">
                                                    <div class="item_image">
                                                        <img src="{{asset('assets/images/shop/classic_ecommerce/img_06.png')}}" alt="image_not_found">
                                                    </div>
                                                </div>
                                                <ul class="product_action_btns ul_li_center clearfix">
                                                    <li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
                                        ...
                                        <div class="ecommerce_product_grid">
                                            <div class="tab-content">
                                                ...
                                                <div id="ptab5_3" class="tab-pane fade">
                                                    <div class="item_image">
                                                        <img src="{{asset('assets/images/shop/classic_ecommerce/img_07.png')}}" alt="image_not_found">
                                                    </div>
                                                </div>
                                                <ul class="product_action_btns ul_li_center clearfix">
                                                    <li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
                                        ...
                                        <div class="ecommerce_product_grid">
                                            <div class="tab-content">
                                                ...
                                                <div id="ptab6_3" class="tab-pane fade">
                                                    <div class="item_image">
                                                        <img src="{{asset('assets/images/shop/classic_ecommerce/img_08.png')}}" alt="image_not_found">
                                                    </div>
                                                </div>
                                                <ul class="product_action_btns ul_li_center clearfix">
                                                    <li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
                                        ...
                                        <div class="ecommerce_product_grid">
                                            <div class="tab-content">
                                                ...
                                                <div id="ptab7_3" class="tab-pane fade">
                                                    <div class="item_image">
                                                        <img src="{{asset('assets/images/shop/classic_ecommerce/img_09.png')}}" alt="image_not_found">
                                                    </div>
                                                </div>
                                                <ul class="product_action_btns ul_li_center clearfix">
                                                    <li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
                                        ...
                                        <div class="ecommerce_product_grid">
                                            <div class="tab-content">
                                                ...
                                                <div id="ptab8_3" class="tab-pane fade">
                                                    <div class="item_image">
                                                        <img src="{{asset('assets/images/shop/classic_ecommerce/img_10.png')}}" alt="image_not_found">
                                                    </div>
                                                </div>
                                                <ul class="product_action_btns ul_li_center clearfix">
                                                    <li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
                        ...
                        <div class="row no-gutters justify-content-lg-between">
                            <div class="col-lg-6">
                                <div class="ce_offer_fullimage offer_fullimage text-white text-center">
                                    <img src="{{asset('assets/images/offer/classic_ecommerce/img_01.jpg')}}" alt="image_not_found">
                                    <div class="item_content">
                            ...
                            <div class="col-lg-6">
                                <div class="ce_offer_fullimage offer_fullimage text-white text-center">
                                    <img src="{{asset('assets/images/offer/classic_ecommerce/img_02.jpg')}}" alt="image_not_found">
                                    <div class="item_content">
