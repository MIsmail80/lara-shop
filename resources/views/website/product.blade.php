                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                        <div class="shop_details_content">
                            ...
                            <ul class="product_info ul_li_block clearfix">
                                <li><strong>SKU:
                                    </strong> {{$product->sku}}</li>
                                <li><strong>category:</strong>
                                    <a href="{{route('website.categories' ,$product->category->id )}}">{{$product->category->name}}</a>
                        ...
                        <div class="row mb_50">
                            <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 order-last">
                                <div class="image_wrap">
                                    <img src="{{ asset('assets/images/details/shop/img_07.jpg') }}"
                                        alt="image_not_found">
                                </div>
                            </div>
